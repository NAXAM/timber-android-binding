...
var slnPath = "./Naxam.Timber.sln";
var artifacts = new [] {
    new Artifact {
        Name = "",
        Version = VERSION,
        AssemblyInfoPath = "./Naxam.Jakewharton.Timber/Properties/AssemblyInfo.cs",
        NuspecPath = "./timber.nuspec",
        DownloadUrl = "http://central.maven.org/maven2/com/jakewharton/timber/timber/{0}/timber-{0}.aar",
        JarPath = "./Naxam.Jakewharton.Timber/Jars/timber.aar"
    },
};
